...
class UserCollectionItems(Resource):
    ...
    def delete(self, user_name):
        item = {
            ...
            "purchase_date": "07/21/20",
            "expiration_date": "08/04/20",
            "count": 3,
        }
        item_name = item["name"]
        ...
        for index in range(0, len(db_item)):
            if db_item[index]["name"] == item_name:
                collection.update_one(
                    {"user_name": user_name}, {"$pull": {"user_items": db_item[index]}}
                )
    ...
    def put(self, user_name):
        ...
        item = {
            "name": "oranges",
            "category": "orangesbetterthanapples",
            "purchase_date": "11/21/21",
            "expiration_date": "12/04/21",
            "count": 5,
        }
        item_name = item["name"]
